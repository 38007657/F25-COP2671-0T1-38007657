...
**What Happens:**# Kelsey Hodge F25-COP2671-0T1-38007657 Final Project Submission - Unity 2D Farming Simulation Game 
...
- KN's image appears above your character with particle effects (source: screenshot of Canvas profile photo)
- You receive 1000 bonus coins
- The effect lasts for 3 minutes of game time
- KN's image rotates and bobs majestically
...
- Select the game object in hierarchy to see the exact location
- Future development option: Easter Egg location shows particles when player is within a certain radius distance.
